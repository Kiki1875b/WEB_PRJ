...
const firstButton = document.querySelector('.first-button'); //처음 페이지로 가는 버튼
const lastButton = document.querySelector('.last-button'); //마지막 페이지로 가는 버튼
